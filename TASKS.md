...
- [~] 101. Full Windows E2E（Tauri native transport、drag/shadow/dev-panel Fix Pack、Node/Rust checks 与 `tauri dev` 进程启动已通过；原生窗口视觉/UI、Study Center/Review 入口、真实 Supervisor/error 与完整 Windows E2E 待人工验收）

...
本仓库的 `studyguardian-pixel` 与 `builtin-minimal` 是 Phase 6 的原创占位素材，生成工具为 OpenAI ImageGen，生成日期为 2026-09-02，按项目文件中的 Original placeholder 声明使用。发布第三方皮肤时必须在 manifest 中注明作者、来源和许可证；不明确授权的素材不能随仓库发布。
